...
class AppStrings {
  ...
  "A deseos": "To wishlist",
  "A mis vinilos": "To my collection",
  "Abrir discografía": "Open discography",
  "Actualizar precios": "Update prices",
  "Agregado a deseos": "Added to wishlist",
  "Agregado a vinilos": "Added to collection",
  ...
  "Año ↑": "Year ↑",
  "Año ↓": "Year ↓",
  "Buscando en más páginas de álbumes...": "Searching more album pages...",
  "Buscando en todas las páginas...": "Searching all pages...",
  "Buscando esa canción en tus álbumes...": "Searching that song in your albums...",
  "Buscando precios…": "Fetching prices…",
  "Buscando similares…": "Finding similar…",
  "Buscando álbumes...": "Searching albums...",
  "Búsqueda por texto (artista + álbum)": "Text search (artist + album)",
  "Búsqueda por texto (sin EAN)": "Text search (no EAN)",
  "Cambiar": "Change",
  "Cargando más álbumes...": "Loading more albums...",
  "Cargando…": "Loading…",
  "Carátula (opcional)": "Cover (optional)",
  "Cámara": "Camera",
  "Detalles": "Details",
  "Discografía": "Discography",
  "Edición seleccionada": "Selected edition",
  "Edición: auto": "Edition: auto",
  "Edición: seleccionada (barcode)": "Edition: selected (barcode)",
  "Ej: Chile, Finlandia": "e.g. Chile, Finland",
  "Ej: Finlandia": "e.g. Finland",
  "Ej: King Crimson": "e.g. King Crimson",
  "El año guardado será el de la primera edición (si existe).": "The saved year will be the first edition year (if available).",
  "Elegir de galería": "Choose from gallery",
  "Elige una edición": "Choose an edition",
  "Error": "Error",
  "Error cargando deseos": "Error loading wishlist",
  "Escribe un artista para ver sugerencias.": "Type an artist to see suggestions.",
  "Esta app sirve para registrar tu colección (LPs), mantener una lista de deseos, y ayudarte a encontrar datos (discografías) y precios en tiendas seleccionadas.": "This app helps you track your record collection (LPs), keep a wishlist, and find info (discographies) and prices from selected stores.",
  "Explora y agrega vinilos para tenerlos a mano.": "Browse and add records to keep them handy.",
  "Favorito": "Favorite",
  "Filtrando canciones": "Filtering tracks",
  "Filtrar": "Filter",
  "Foto": "Photo",
  "Fuentes de precio": "Price sources",
  "Guardar en canciones": "Save to tracks",
  "ID colección": "Collection ID",
  "Los precios pueden cambiar en la tienda.": "Prices may change in the store.",
  "Marca tus deseos como comprados para verlos aquí.": "Mark wishlist items as bought to see them here.",
  "Más tarde": "Later",
  "Nada para agregar": "Nothing to add",
  "No pude leer la base de datos. Intenta de nuevo.": "I couldn't read the database. Try again.",
  "No se pudo abrir el enlace": "Couldn't open the link",
  "No se pudo buscar en MusicBrainz. Intenta de nuevo.": "Couldn't search MusicBrainz. Try again.",
  "No se pudo calcular similitudes. Intenta de nuevo.": "Couldn't calculate similarities. Try again.",
  "No se pudo explorar": "Couldn't explore",
  "No se pudo explorar en MusicBrainz. Intenta de nuevo.": "Couldn't explore on MusicBrainz. Try again.",
  "Número de artista": "Artist number",
  "Número de disco": "Album number",
  "Número de vinilo": "Record number",
  "Número inválido": "Invalid number",
  "Número de artista inválido.": "Invalid artist number.",
  "Número de disco inválido.": "Invalid album number.",
  "Ese número de artista ya está usado.": "That artist number is already used.",
  "Ese código ya está usado.": "That code is already used.",
  "Ese número ya está usado.": "That number is already used.",
  "País": "Country",
  "País (opcional)": "Country (optional)",
  "Precio": "Price",
  "Precio no encontrado": "Price not found",
  "Precios": "Prices",
  "Precios en tiendas": "Store prices",
  "Prueba con otro género, país o rango de años.": "Try another genre, country, or year range.",
  "Quitar carátula": "Remove cover",
  "Quitar de canciones": "Remove from tracks",
  "Reintentar": "Retry",
  "Relevancia": "Relevance",
  "Revisar": "Review",
  "Sin comprados": "No bought items",
  "Sin precios": "No prices",
  "Sin sugerencias.": "No suggestions.",
  "Sugerencias": "Suggestions",
  "Tienes vinilos comprados en deseos": "You have bought records in your wishlist",
  "Tu colección de vinilos, simple y rápida.": "Your record collection, simple and fast.",
  "Título A–Z": "Title A–Z",
  "Ver ediciones": "View editions",
  "Ya está en deseos": "Already in wishlist",
  "más": "more",
  "¿Dónde quieres agregar este álbum?": "Where do you want to add this album?",
  "¿Quieres agregarlos a Mis vinilos?": "Do you want to add them to My records?",
  "• AppVinilos: los precios/alertas se basan en Vinilo 12\" LP (LP, 2LP, 3LP, 4LP). Se excluyen EP, 7\", singles y otros formatos.": "• AppVinilos: prices/alerts are based on 12\" LP vinyl (LP, 2LP, 3LP, 4LP). EPs, 7\", singles and other formats are excluded.",
  "• Exportar manual: en Ajustes > Ayuda puedes exportar este manual a PDF para compartirlo o imprimirlo.": "• Export manual: in Settings > Help you can export this manual to PDF to share or print.",
  "• Precios: se muestran solo como referencia. Algunas tiendas cambian valores o bloquean consultas automáticas.": "• Prices: shown for reference only. Some stores change values or block automated queries.",

  "GaBoLP — Manual de uso": "GaBoLP — User manual",
  "AppVinilos: los precios/alertas se basan en Vinilo 12\" LP (LP, 2LP, 3LP, 4LP). Se excluyen EP, 7\", singles y otros formatos.": "AppVinilos: prices/alerts are based on 12\" LP vinyl (LP, 2LP, 3LP, 4LP). EPs, 7\", singles and other formats are excluded.",

  "En Inicio toca Discos para ir a Discografías: busca un artista, revisa álbumes y agrega a Lista o Deseos.": "On Home, tap Records to open Discographies: search an artist, browse albums and add to Collection or Wishlist.",
  "En Inicio toca OST para buscar bandas sonoras (película/serie/juego). Al escribir 1–2 letras aparecen sugerencias.": "On Home, tap OST to search soundtracks (movie/series/game). Type 1–2 letters to see suggestions.",
  "OST (Soundtracks)": "OST (Soundtracks)",
  "OST: iconos en resultados": "OST: result icons",
  "Agrega el soundtrack a tu colección. Te pedirá condición y formato (LP).": "Add the soundtrack to your collection. It will ask for condition and format (LP).",
  "Marca como favorito (requiere que el disco exista en tu colección).": "Mark as favorite (requires the record to exist in your collection).",
  "Agrega a la wishlist y elige estado (por comprar / comprado).": "Add to the wishlist and choose status (to buy / bought).",
  "€ (Precios)": "€ (Prices)",
  "Busca precios en tiendas activadas para ese soundtrack.": "Find prices in enabled stores for that soundtrack.",
  "Cuadros / Lista": "Cards / List",
  "Cambia la vista de resultados entre cards y lista compacta.": "Switch the results view between cards and a compact list.",
  "Guía rápida de pantallas, botones y flujos.": "Quick guide to screens, buttons and flows.",
  "En la app: Ajustes > Ayuda > Manual de uso.": "In the app: Settings > Help > User manual.",
  "Buscar discografías y OST (soundtracks) y agregar discos más rápido (código de barras, carátula o manual).": "Search discographies and OST (soundtracks) and add records faster (barcode, cover, or manual).",
  "En Inicio toca Discos para ir a Discografías: busca artistas y álbumes, y agrega a Lista o Deseos.": "On Home, tap Records to open Discographies: browse artists and albums, and add to Collection or Wishlist.",
  "En Inicio toca OST para buscar bandas sonoras. Al escribir 1–2 letras aparecen sugerencias.": "On Home, tap OST to search soundtracks. Type 1–2 letters to see suggestions.",
  "Busca bandas sonoras por título (película/serie/juego) y abre la ficha (canciones) para agregar a Lista o Deseos.": "Search soundtracks by title (movie/series/game) and open details (tracks) to add to Collection or Wishlist.",
  "Lista": "List",
  "Deseos": "Wishlist",
  "Inicio": "Home",
  "Vinilos": "Records",
  "Botones y qué hacen": "Buttons and what they do"
};
